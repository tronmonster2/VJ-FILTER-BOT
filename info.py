...
API_ID = int(environ.get('API_ID', '20315231'))
API_HASH = environ.get('API_HASH', '57b8c14da8f8ae82f1e531d4138c6e4f')
BOT_TOKEN = environ.get('BOT_TOKEN', "6589047409:AAFwwKDDbS2dc_Vy7j4XTQQAgzO4PoWDKYk")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2020973918').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001997033812').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'Alpha_support_grp')
reqst_channel = environ.get('REQST_CHANNEL_ID', 'Alpha_support_grp')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Cluster0:D9QUEgzUlg19BFxh@cluster0.5dzvhrt.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '785d8ad793f05ca4caf0e7a0ea5dd716201a59c2')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Alpha_support_grp')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+S9w35f7BDNhlMTBl')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002064829273'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Alpha_support_grp')
